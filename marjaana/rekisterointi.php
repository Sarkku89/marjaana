...
<div id = "content">
    <main>
        ...
        <input type="text" name="user_username" id="user_username" size="20" value="" required><br>
        <label for ="user_email">Sähköposti</label><br>
        <input type="text" name="user_email" id="user_email" size="50" value="" required><br>
        <label for ="user_password">Salasana</label><br>
        <input type="password" name="user_password" id="user_password" size="20" value="" required><br>
        <label for ="user_password_c">Vahvista salasana</label><br>
        <input type="password" name="user_password_c" id="user_password_c" size="20" value="" required><br>
