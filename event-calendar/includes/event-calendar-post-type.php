...
function ecal_date_box_html($post){
...
function ecal_organizer_box_html($post){
...
function ecal_first_judge_box_html($post){
...
function ecal_second_judge_box_html($post){
...
function ecal_limit_box_html($post){
...
function ecal_maxmin_box_html($post){
...
function ecal_priority_box_html($post){
...
function ecal_enrollment_box_html( $post ) {
...
function ecal_price_box_html($post){
...
function ecal_info_box_html($post){
...
function ecal_other_box_html($post){
...
function ecal_contact_box_html($post){
...
function ecal_class_box_html($post){
...
function ecal_place_box_html($post){
...
function ecal_address_box_html($post){
